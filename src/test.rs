...
mod tests{
    ...
    fn test_fft() {
        ...
        let mut expected: Array2<Complex<f32>> = array![[Complex::new( 45.0,  0.        ), Complex::new(-4.5, 2.59807621), Complex::new(-4.5, -2.59807621)],
    ...
    #[test]
    fn test_ifft() {
        let mut input: Array2<Complex<f32>> = array![[Complex::new( 45.0,  0.        ), Complex::new(-4.5, 2.59807621), Complex::new(-4.5, -2.59807621)],
                                                        [Complex::new(-13.5,  7.79422863), Complex::new( 0.0, 0.        ), Complex::new( 0.0,  0.        )],
                                                        [Complex::new(-13.5, -7.79422863), Complex::new( 0.0, 0.        ), Complex::new( 0.0,  0.        )]];
        let mut output: Array2<Complex<f32>> = Array::zeros((3,3));
        let mut expected: Array2<Complex<f32>> = array![[Complex::new(1.,0.), Complex::new(2.,0.), Complex::new(3.,0.)],
